  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-neutral-950 transition duration-300">
      ...
      <div className="container pb-10 max-w-7xl mx-auto px-4">
        <section id="home" ref={homeRef} className={`transition-opacity duration-1000 ${homeInView ? 'opacity-100' : 'opacity-0'}`}>
          <Home />
        </section>
        <section id="about" ref={aboutRef} className={`transition-opacity duration-1000 ${aboutInView ? 'opacity-100' : 'opacity-0'}`}>
          <About />
        </section>
        <section id="experience" ref={experienceRef} className={`transition-opacity duration-1000 ${experienceInView ? 'opacity-100' : 'opacity-0'}`}>
          <Experience />
        </section>
        <section id="projects" ref={projectsRef} className={`transition-opacity duration-1000 ${projectsInView ? 'opacity-100' : 'opacity-0'}`}>
          <Projects />
        </section>
