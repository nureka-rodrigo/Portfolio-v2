  ...
  return (
    <section className="container mx-auto px-4 pt-20">
      <div className="flex flex-col items-center mb-16">
        <h2
          className="text-4xl text-yellow-600 dark:text-yellow-500 font-bold text-center transition duration-300">Experience</h2>
      </div>
            ...
            selectedExperience === index && (
              ...
              >
                <h3 className="text-2xl font-bold text-yellow-600 dark:text-yellow-500 transition duration-300">
                  ...
                  className="text-neutral-900 dark:text-gray-100 transition duration-300">@{experience.company}</span>
                </h3>
                <p className="text-neutral-600 dark:text-gray-400 mt-2 transition duration-300">
                  {new Date(experience.start).toLocaleDateString('en-US', {
                    year: 'numeric',
                    month: 'long'
                  })} - {experience.end ? new Date(experience.end).toLocaleDateString('en-US', {
                  year: 'numeric',
                  month: 'long'
                }) : 'Present'}
                </p>
