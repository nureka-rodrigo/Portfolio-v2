    ...
    <div className="hidden xl:flex lg:flex-col lg:items-center fixed right-8 bottom-0 mb-4">
      <div className="flex flex-col items-center">
        ...
        <a
          ...
          aria-label="Email me at nurekadulshanmc@gmail.com"
        >
          nurekadulshanmc@gmail.com
        </a>
        {/* Vertical line below the email link */}
        <div className="w-px bg-gray-500 dark:bg-gray-300 h-24 mt-4 transition duration-300 hover:bg-yellow-500 dark:hover:bg-yellow-600"></div>
      </div>
    </div>
  );
};
